...
//
// domflax matches on the *computed* styles, not the raw class strings, so equivalent class sets
// collapse to their shortest Tailwind form:
//   • `px-4 py-4`        → `p-4`
//   • `w-8 h-8`          → `size-8` (or the shortest equivalent the resolver emits)
